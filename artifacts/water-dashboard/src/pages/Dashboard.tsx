...
function getTheme(dark: boolean) {
  ...
  return {
    page: "linear-gradient(135deg, #e0f7fa 0%, #ffffff 50%, #b2ebf2 100%)",
    ...
    textMuted: "#0891b2",
    textSub: "#64748b",
    tickBg: "rgba(6,182,212,0.3)",
    progressTrack: "rgba(6,182,212,0.12)",
    metricCardBg: "rgba(224,247,250,0.7)",
    metricCardBorder: "rgba(6,182,212,0.18)",
    pumpStatusBg: "rgba(224,247,250,0.7)",
    pumpStatusBorder: "rgba(6,182,212,0.2)",
    footerBg: "rgba(255,255,255,0.7)",
    footerBorder: "rgba(6,182,212,0.25)",
    footerText: "#0891b2",
    tankOutline: "rgba(6,182,212,0.35)",
    tankInner: "rgba(224,247,250,0.5)",
    chartGrid: "rgba(6,182,212,0.08)",
    chartLegend: "#0891b2",
    chartTooltipBg: "rgba(255,255,255,0.95)",
    chartTooltipTitle: "#0c4a6e",
    chartTooltipBody: "#0891b2",
    accentBlue: "#0891b2",
    accentPurple: "#7c3aed",
    noteCode: "rgba(6,182,212,0.1)",
    noteCodeText: "#0e7490",
    toggleBg: "rgba(6,182,212,0.08)",
    toggleBorder: "rgba(6,182,212,0.25)",
    toggleText: "#0891b2",
    overrideCardBg: "rgba(251,191,36,0.06)",
    overrideCardBorder: "rgba(245,158,11,0.25)",
  };
}
